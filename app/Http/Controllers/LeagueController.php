...
class LeagueController extends Controller
{
    ...
    public function mealStore(Request $request)
    {
        ...
        \App\Models\PointTransaction::awardPoints(Auth::id(), 'meal_posted', 'Repas partagé depuis les ligues');
        ...
        return redirect()->route('social.show', $post)
            ->with('success', 'Votre repas a été partagé et analysé par notre IA ! 📸🍽️🤖');
    }
} 